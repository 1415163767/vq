...
run_name="qwen3_vl_vq_eam"
output_dir=/blob/dyb_output/qwen3_vl_vq_eam
...
args="
    ...
    --add_image_data True \
    --add_zehui_data True \
    --add_zeyuan_data True \
    --add_llava_video_data True \
