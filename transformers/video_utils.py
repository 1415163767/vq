...
def default_sample_indices_fn(metadata: VideoMetadata, num_frames=None, fps=None, stride=None, **kwargs):
    """
    ...
    **kwargs,
    ...
    if sample_indices_fn is None:
        ...
        def sample_indices_fn_func(metadata, **fn_kwargs):
            stride = fn_kwargs.pop("stride", 2)
            return default_sample_indices_fn(metadata, num_frames=num_frames, fps=fps, stride=stride, **fn_kwargs)
